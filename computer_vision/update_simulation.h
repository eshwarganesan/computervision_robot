...
// *NOTE: don't modify vision_simulation.h or vision_simulaton.cpp
// to update the simulation if possible. Follow the examples
// below if you want to change parmaters in the simulation.
